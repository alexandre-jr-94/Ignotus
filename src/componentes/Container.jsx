    ...
    return(
        ...
        <div className=' mr-20'>
                ...
                <div className='flex justify-end'>
                    <div>
                        <p className='bg-blue-900 px-7 py-3 rounded-lg'> Olá! Como posso ter uma maior privacidade na Internet utilizando o Firefox?</p>
                    </div>
                </div>
            ...
            <div className=" bg-neutral-700 text-justify w-11/12 ml-24 mt-1 mr-0 rounded-lg px-7">
                <div className="flex ">
                    <p className=" text-justify pt-9 content-center ">
                    ...
                    <img src={CCTV} alt="Monitoramento" className=' w-6/12 h-fit ' />
                </div>
            </div>
            <div className=' mr-20'>
                <div className=' text-zinc-500 ml-24 mt-12'>
                ...
                <div className='flex justify-end'>
                    <div>
                        <p className='bg-blue-900 px-7 py-3 rounded-lg'> Quais Extensões devo ter para maior privacidade no Firefox?</p>
                    </div>
                </div>
            ...
            <div>
                ...
                <div className="bg-neutral-700 text-justify w-11/12 ml-24 mt-1 mr-0 rounded-lg px-7 py-9">
                    ...
                    <div className="bg-neutral-700 text-justify w-11/12 ml-24 mt-1 mr-0 rounded-lg px-7 py-9">
                        <p>
                            ...
                            <div className='bg-neutral-600 p-2 rounded-lg'>
                                ...
                                geo.enabled = false | <em className=' text-zinc-400' > Essa preferência é ativada por padrão e utiliza os Serviços de localização do Google para identificar sua localização. </em> <br/>
                                media.eme.enabled = false | <br/>
                                media.navigator.enabled = false | <br/>
                                media.peerconnection.enabled = false | <em className='text-zinc-400'>WebRTC significa “Web Real-Time Communication” e permite voz, bate-papo por vídeo e compartilhamento P2P através do seu navegador. Infelizmente, esse recurso também pode expor seu endereço IP real</em> <br/>
